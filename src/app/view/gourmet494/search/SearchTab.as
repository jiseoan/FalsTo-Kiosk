package app.view.gourmet494.search 
{
	...
	public class SearchTab extends Sprite 
	{
		...
		public function SearchTab() 
		{
			...
			_tab1 = new Button([new ImageBox("gourmet/tab_search"), new ImageBox("gourmet/tab_search_press")]);
			_tab2 = new Button([new ImageBox("gourmet/tab_category"), new ImageBox("gourmet/tab_category_press")]);
